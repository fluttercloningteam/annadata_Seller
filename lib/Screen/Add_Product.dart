              ...
              content: Column(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: TextField(
                      controller: zipController, // Assign the controller
                      decoration: InputDecoration(
                      ...
                      onChanged: (value) {
                        if (value != '' && value != null) {
                          ...
                          for (var i = 0; i < zipCodeList.length; i++) {
                            if (zipCodeList[i].zipcode!.contains(value)) {
                              zipSearchList.add(zipCodeList[i]);
                            }
                          }
                        } else {
                          zipSearchList = [];
                      ...
                      //   if (value.isNotEmpty) {
                      //     // Handle submission
                      //     // Example: setState(() { deliverableZipcodes = value; });
                      //   }
                      // },
                    ),
                  ),
  ...
  Future<void> addProductAPI(List<String> attributesValuesIds) async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        request.fields[QuantityStepSize] = "1";
